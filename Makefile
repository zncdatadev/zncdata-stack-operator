...
# zncdata.net/zncdata-stack-operator-bundle:$VERSION and zncdata.net/zncdata-stack-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= $(RETISTRY)/zncdata-stack-operator
...
IMG ?= $(RETISTRY)/zncdata-stack-operator:$(VERSION)
